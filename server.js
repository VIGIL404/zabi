...
const youtube = new YouTube("AIzaSyCnCUh6xBDDgzwcemMqHPlo476MrPfk7lw"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyCnCUh6xBDDgzwcemMqHPlo476MrPfk7lw"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("ready", () => {
  ...
  client.user.setActivity(`${prefix}help`, { type: "" });
});
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@481555548601450506>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
